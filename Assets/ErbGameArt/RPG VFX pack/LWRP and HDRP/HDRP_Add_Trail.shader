Shader "EGA/HDRP/Particles/Add_Trail"
{
    Properties
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
						...
						)
				{
					...
					float2 uv1 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float U6 = uv1.x;
					...
					float4 temp_output_51_0 = ( packedInput.ase_color.a * Main57 * Dissolve49 * clampResult24 );
					float4 screenPos = packedInput.ase_texcoord1;
					float4 ase_screenPosNorm = screenPos / screenPos.w;
					ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
					float screenDepth62 = LinearEyeDepth( SampleCameraDepth( screenPos.xy/screenPos.w ).r,_ZBufferParams);
					...
					surfaceDescription.Alpha = staticSwitch65.r;
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput) : SV_Target
				{
					...
					surfaceDescription.Color =  ( ( lerpResult3 * packedInput.ase_color * _Emission ) * staticSwitch55 ).rgb;
					surfaceDescription.Alpha = staticSwitch65.r;
					surfaceDescription.AlphaClipThreshold =  0;
