Shader "EGA/HDRP/Particles/Add_DistortTexture"
{
    Properties
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput) : SV_Target
				{
					...
					float4 temp_output_30_0 = ( tex2DNode13 * _Color * packedInput.ase_color * tex2DNode13.a * _Color.a * packedInput.ase_color.a );
					...
					surfaceDescription.Color =  ( staticSwitch47 * _Emission ).rgb;
					surfaceDescription.Alpha = 1;
					surfaceDescription.AlphaClipThreshold =  0;
