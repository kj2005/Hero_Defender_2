Shader "ErbGameArt/Particles/Blend_LitGlow" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                return fixed4(finalColor,(lerp( node_6301, (node_6301*saturate((sceneZ-partZ)/_Depthpower)), _Usedepth )*_Opacity));
            }
            ENDCG
        }
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(node_8986, _Noise));
                float node_6301 = (_MainTex_var.a*_Noise_var.a*i.vertexColor.a*_TintColor.a);
                return fixed4(node_2600 * (lerp( node_6301, (node_6301*saturate((sceneZ-partZ)/_Depthpower)), _Usedepth )*_Opacity),0);
            }
            ENDCG
        }      
    }
